      ...
      <div className="main">
        ...
        {/* -----------------------------------------Top Card Start---------------------------------- */}
          ...
          <Row>
            ...
            <Col md={6}>
            <Card className="mainCard2 p-2"  onClick={()=>navigate("AwaitingsamplesApprover")}>
            <div className="cardArrangement">
                <div >
...
{/* -----------------------------------------Top Card Ended---------------------------------- */}
            ...
            <div className="topforsamplewaitingandviewall">
                <p onClick={()=>navigate("AwaitingSamplesApprover")} className="tableTop mt-3">Awaiting Approve</p>
                <a href="./AwaitingSamplesApprover" className="viewAll" onClick={()=>navigate("AwaitingSamplesApprover")}>View all</a>
