...
<div className='d-flex'>
            ...
            <div className='main'>
                ...
                <p className="tableTop mt-3" onClick={()=>navigate("AnalystBatchandRLPLdetails")}>Samples awaiting testing</p>
                <a href='AnalystBatchandRLPLdetails' className='viewAll'>View all</a>
                ...
                <tr >
                    ...
                    <td>XXXXX</td>
                    <td>XXXXX</td>
                    <td><button className="tbbutton "
                    onClick={()=>navigate("AnalystBatchandRLPLdetails")}>View</button></td>
                </tr>
