...
export default function SearchTDS() {
  ...
  return (
    ...
    <div className='d-flex'>
      ...
      <td>{combineValues(analystView.batchDetails.batchSize)}</td>
  ...
  <th>RLPL Number</th>
    ...
    <td> <text style={{backgroundColor:"##9AC037"}}>{analystView.status}</text></td>
    </tr>
    </tbody>
