...
<div className="d-flex">
      ...
      <div className="mainitem">
        ...
        <div className="mt-3">
          <div className='titlemainreference'>
            ...
            <text className='titlesubreference'>TDS Number: TDS/XRD/23/19923</text>
            </div>
            <hr />
          </div>
  ...
  <tr>
    ...
    <td>SOR.doc</td>
          ...
          <div className="mt-3">
            <text className="mainheadtitlesub">Test Data Sheet & System Generated Copy</text>
            <hr />
          </div>
...
<Row>
    ...
    <text className='analysttestdata-text ms-2'>ANALYTICAL DATA.docs</text>
    </div>
    <div>
    <AiOutlineEye size={28} color='#9AC037'  />
    <BsArrowDownCircle size={24} color='#9AC037' className='ms-4' />
    </div>
    </div>
    ...
    <div className='analysttestdata mt-2'>
        <div>
    <RiFileWord2Fill size={24} color='#2368C4'/>
    <text className='analysttestdata-text ms-2'>SPECIFIC OPTICAL ROTATION TDS.docs</text>
    </div>
    <div>
    <AiOutlineEye size={28} color='#9AC037'  />
    <BsArrowDownCircle size={24} color='#9AC037' className='ms-4' />
