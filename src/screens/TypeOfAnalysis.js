                        ...
                        <div className="col">
                                ...
                                >
                                  ...
                                  <Input
                                    ...
                                    onChange={() => setSelectedOptionvalid("No")}
                              ...
                              <div className="col">
                                ...
                                >
                                  ...
                                  <Input
                                    ...
                                    onChange={() => setSelectedOptionvalid("Yes")}
                                    name="methodvalidation"
...
<div className="col">
                                ...
                                >
                                  ...
                                  <Input
                                    ...
                                    id="Reference No"
                                    value="Reference No"
                                    checked={selectedOptionmet === "Reference No"}
                                    onChange={() => setSelectedOptionmet("Reference No")}
                                    name="methodologyfollowed"
                        ...
                        <div style={{ alignItems: "center", display: "flex" }}>
                          {selectedOptionmet === "Reference No" && (
                            <Input {...register("referencetext")}
                             type="text" className="methodology"
                            />
                          )}
                          </div> 
                      </div>
